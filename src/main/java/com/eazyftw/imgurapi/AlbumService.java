...
public class AlbumService {
	 ...
	 */
	public Album getAlbum( String albumId ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException bad
	 */
	public List<Image> getAlbumImages( String albumId ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException oops
	 */
	public Album addAlbum( Album album ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException oops
	 */
	public boolean updateAlbum( Album album ) throws ImgurApiException {
	 ...
	 */
	public boolean deleteAlbum( Album album ) throws ImgurApiException {
		Call<ImgurResponseWrapper<Boolean>> call =
	 ...
	 * @throws ImgurApiException well nuts
	 */
	public void favoriteAlbum( Album album ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException well nuts
	 */
	public void unfavoriteAlbum( Album album ) throws ImgurApiException {
		if( !client.authService().isUserAuthenticated() ) {
			throw new ImgurAuthException( "No user logged in", 401 );
		} // if
	 ...
	 * @throws ImgurApiException oh no!
	 */
	public Album addAlbumImageId(
			Album album,
			String imageId ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException ugh
	 */
	public Album addAlbumImageIds(
			Album album,
			List<String> imageIds ) throws ImgurApiException {
	...
	public Album deleteAlbumImageId(
			Album album, String imageId ) throws ImgurApiException {
	...
	protected AlbumService(ImgurApiClient imgurClient, GsonBuilder gsonBuilder) {
