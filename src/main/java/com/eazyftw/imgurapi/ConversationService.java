...
import com.eazyftw.imgurapi.model.Conversation;
...
public class ConversationService {
	 ...
	 * @throws ImgurApiException Imgur crashed
	 */
	public List<Conversation> getConversations() throws ImgurApiException {
	...
	public boolean sendMessage(
			String toUserName,
			String body ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException indicator of not-success
	 */
	public boolean deleteConversation(
			long conversationId ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException unsuccessful
	 */
	...
	protected ConversationService(ImgurApiClient imgurClient, GsonBuilder gsonBuilder) {
