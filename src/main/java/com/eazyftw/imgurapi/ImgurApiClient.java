...
import com.eazyftw.imgurapi.util.RetrofittedImgur;
...
/**
 * The ImgurApi client that is the foundation for all API calls to Imgur
...
public class ImgurApiClient {
	...
	/**
	 * This is used to construct a new ImgurApiClient
	 * @author Evan Zimmerman
	 *
	 */
	public static class Builder {
		...
		/**
		 * Constructs the ImgurApiClient and returns it
		 * @return The ImgurApi client
		 * @throws ImgurApiException Unable to build the client
		 */
		public ImgurApiClient build() throws ImgurApiException {
			ImgurApiClient client = new ImgurApiClient( _clientId, _clientSecret );
	...
	public static void setApiEndpoint( String url ) {
		ImgurApiClient.apiEndpoint = url;
	}
	...
	public static String getApiEndpoint() {
		return ImgurApiClient.apiEndpoint;
	}
	 ...
	 * @throws ImgurApiException the clientId or clientSecret were not supplied
	 */
	protected ImgurApiClient(String clientId, String clientSecret ) throws ImgurApiException {
		if( clientId == null || clientSecret == null ) {
			throw new ImgurApiException( "Must have clientId and clientSecret to run ImgurApi.  See http://api.imgur.com/");
		} // if
	...
	private static final Logger log = Logger.getLogger( ImgurApiClient.LOG_NAME );
