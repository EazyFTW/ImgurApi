...
package com.eazyftw.imgurapi.util;

import java.util.List;
import java.util.Map;


import com.eazyftw.imgurapi.CommentService;
import com.eazyftw.imgurapi.model.*;
...
public interface RetrofittedImgur {
	...
	Call<ImgurResponseWrapper<CommentService.CommentListWrapper>> listCommentReplies(
			@Path("id") long commentId );
