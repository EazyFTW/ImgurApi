...
package com.eazyftw.imgurapi.model.search;
...
public class CompoundSearchQuery  {
	 ...
	 * @return user element
	 * @throws ImgurApiException a rule was broken 
	 */
	public CompoundSearchQuery user( String userName ) throws ImgurApiException {
		lastElement = user;
	 ...
	 * @throws ImgurApiException a rule was broken 
	 */
	public CompoundSearchQuery title( String word ) throws ImgurApiException {
		lastElement = title;
	 ...
	 * @throws ImgurApiException a rule was broken
	 */
	public CompoundSearchQuery extension( String ext ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException a rule was broken
	 */
	public CompoundSearchQuery subreddit( String subreddit ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException a rule was broken 
	 */
	public CompoundSearchQuery album( String word ) throws ImgurApiException {
		lastElement = album;
	 ...
	 * @throws ImgurApiException a rule was broken 
	 */
	public CompoundSearchQuery meme( String word ) throws ImgurApiException {
		lastElement = meme;
	 ...
	 * @throws ImgurApiException a rule was broken
	 */
	public CompoundSearchQuery and( String word ) throws ImgurApiException {
		if( lastElement == null ) {
			throw new ImgurApiException( "Cannot AND without a preceding"
	 ...
	 * @throws ImgurApiException a rule was broken
	 */
	public CompoundSearchQuery or( String word ) throws ImgurApiException {
		if( lastElement == null ) {
			throw new ImgurApiException( "Cannot OR without a preceding"
					+ " search element such as user(...) or title(...)" );
		} // if
	...
	public class QueryElement {
		 ...
		 * @throws ImgurApiException a rule was broken
		 */
		public CompoundSearchQuery set( String entry ) throws ImgurApiException {
			if( !entries.isEmpty() ) {
				throw new ImgurApiException( "Cannot add SET entries to a"
		 ...
		 * @throws ImgurApiException a rule was broken
		 */
		public CompoundSearchQuery and( String entry ) throws ImgurApiException {
			if( oring ) {
				throw new ImgurApiException( "Cannot add AND entries to a"
		 ...
		 * @throws ImgurApiException a rule was broken
		 */
		public CompoundSearchQuery or( String entry ) throws ImgurApiException {
			if( anding ) {
				throw new ImgurApiException( "Cannot add OR entries to a"
