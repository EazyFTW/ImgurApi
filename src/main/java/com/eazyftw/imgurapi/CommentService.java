...
public class CommentService {
	 ...
	 * @throws ImgurApiException daaang
	 */
	public Comment getComment( long commentId ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException danger
	 */
	public long addComment(
			String imageOrAlbumId,
			String text ) throws ImgurApiException {
	 ...
	 * @throws ImgurApiException bummer
	 */
	public boolean deleteComment(
			Comment comment ) throws ImgurApiException {
	 ...
	 */
	public boolean deleteComment(
			long commentId ) throws ImgurApiException {
	 ...
	 * @return the id of the new comment
	 * @throws ImgurApiException i can't keep making up dummy explanations here
	 */
	 ...
	 * @throws ImgurApiException Imgur didn't like that
	 */
	...
	protected CommentService(ImgurApiClient imgurClient, GsonBuilder gsonBuilder) {
