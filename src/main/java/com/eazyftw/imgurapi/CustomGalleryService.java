...
import com.eazyftw.imgurapi.model.gallery.CustomGallery;
...
public class CustomGalleryService {
	 ...
	 * @throws ImgurApiException aw heck
	 */
	 ...
	 * @param page the page number, starting from 0
	 * @return a CustomGallery object with the results
	 * @throws ImgurApiException noooooo
	 */
	 ...
	 * @throws ImgurApiException something went sour
	 */
	public boolean addCustomGalleryTag( String tag ) throws ImgurApiException {
	...
	public boolean deleteCustomGalleryTag( String tag ) throws ImgurApiException {
	 ...
	 * @return true if action was taken
	 * @throws ImgurApiException something terrible happened
	 */
	public boolean blockGalleryTag( String tag ) throws ImgurApiException {
	 ...
	 */
	public boolean unblockGalleryTag( String tag ) throws ImgurApiException {
	...
	protected CustomGalleryService(ImgurApiClient client, GsonBuilder gsonBuilder ) {
		this.client = client;
	} 
